-- AGENTLAND.SAARLAND Analytics Tables
...
-- Insert initial test data (real user count starts from 0)
INSERT INTO users (email, name, metadata) 
VALUES ('system@agentland.saarland', 'System User', '{"type": "system", "created_by": "initial_setup"}')
