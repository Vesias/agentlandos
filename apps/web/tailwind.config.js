  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          '0%': { 
            boxShadow: '0 0 5px rgba(253, 185, 19, 0.2), 0 0 10px rgba(253, 185, 19, 0.2), 0 0 15px rgba(253, 185, 19, 0.2)',
            opacity: '0.7'
          },
          '100%': { 
            boxShadow: '0 0 10px rgba(253, 185, 19, 0.4), 0 0 20px rgba(253, 185, 19, 0.4), 0 0 30px rgba(253, 185, 19, 0.4)',
            opacity: '1'
          },
        },
        float: {
