      ...
      <div ref={ref} className={cn("space-y-2", className)}>
        {label && (
          <label className="block text-sm font-semibold text-neutral-gray-800 dark:text-technical-silver-100 mb-1">
            ...
            {required && (
              <span
                className="text-alert-red-600 ml-1 font-bold"
                aria-label="required"
              >
                *
              </span>
    ...
    return (
      <input
        ...
        className={cn(
          ...
          error &&
            "border-alert-red-500 focus-visible:ring-alert-red-300 focus-visible:border-alert-red-600 bg-alert-red-50",
          className,
        )}
        ref={ref}
        {...props}
    ...
    return (
      <div className="relative">
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
          <svg
            className="w-5 h-5 text-neutral-gray-400"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
