...
import { Search, Sparkles, Globe, Database, Bot, Target, ArrowRight } from 'lucide-react'
  ...
  const searchModes = [
    {
      ...
      icon: Globe,
      features: ['Real-time Web-Ergebnisse', 'KI-Zusammenfassung', 'Saarland-Fokus', 'Cross-Border DE/FR/LU'],
      color: 'blue'
    },
    {
      id: 'instant' as const,
      ...
      icon: Database,
      features: ['Lokale Expertise', 'Strukturierte Lösungen', 'Schnelle Antworten', 'Behörden-Services'],
      color: 'purple'
    }
  ]
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <div>
              <h1 className="text-4xl font-bold text-gray-900">AGENTLAND Search</h1>
              <p className="text-gray-600">KI-powered Suchplattform für das Saarland</p>
            </div>
          </motion.div>
          ...
          >
            {searchModes.map(mode => 
              searchMode === mode.id && (
                <div key={mode.id} className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                        ...
                        {mode.features.map((feature, index) => (
                          <div key={index} className="flex items-center gap-2">
                            <Target className={`w-4 h-4 ${
                              mode.color === 'blue' ? 'text-blue-500' : 'text-purple-500'
                            }`} />
        ...
        <div className="max-w-6xl mx-auto mt-16">
          <h2 className="text-2xl font-bold text-gray-900 text-center mb-8">Beispiel-Suchanfragen</h2>
        ...
        <div className="max-w-6xl mx-auto mt-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white">
          <div className="text-center mb-8">
            ...
            <p className="text-blue-100 text-lg">Die erste KI-gestützte Suchplattform speziell für das Saarland</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-blue-100">Intelligente Zusammenfassungen und kontextuelle Antworten durch modernste KI-Technologie</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100">Speziell optimiert für regionale Inhalte, Behörden-Services und Cross-Border-Themen</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100">Keine Registrierung erforderlich - starten Sie sofort mit Ihrer Suche</p>
            </div>
          </div>
